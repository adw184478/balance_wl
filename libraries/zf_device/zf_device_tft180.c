...
//tft_draw_circle(func_limit_ab(x, 10, 110), func_limit_ab(y,10,50), uesr_RED);
void tft_draw_circle(uint16 x, uint16 y, const uint16 color)
{
    int R=3;
    tft180_draw_point(x-R,y-R,color);
    tft180_draw_point(x+R,y+R,color);
    tft180_draw_point(x+R,y-R,color);
    tft180_draw_point(x-R,y+R,color);

    tft180_draw_point(x,y-R,color);
    tft180_draw_point(x,y+R,color);
    tft180_draw_point(x+R,y,color);
    tft180_draw_point(x-R,y,color);

    tft180_draw_point(x+R,y+R-1,color);
    tft180_draw_point(x-R,y+R-1,color);
    tft180_draw_point(x+R-1,y+R,color);
    tft180_draw_point(x+R-1,y-R,color);

    tft180_draw_point(x-1,y-R,color);
    tft180_draw_point(x-1,y+R,color);
    tft180_draw_point(x+1,y-R,color);
    tft180_draw_point(x+1,y+R,color);
    tft180_draw_point(x+R,y-1,color);
    tft180_draw_point(x-R,y-1,color);
    tft180_draw_point(x+R,y+1,color);
    tft180_draw_point(x-R,y+1,color);
}
